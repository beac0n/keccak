...
int main() {
	...
	uint8_t expectedOutput[32] = {
			...
			0xA4, 0xFF, 0x21, 0x02, 0x7F, 0x62, 0xFF,
			0x60, 0x26, 0x7F, 0xF9, 0x55, 0xC9, 0x63,
			0xF0, 0x42, 0xC4, 0x6D, 0xA5, 0x2E, 0xE3,
			0xCF, 0xAF, 0x3D, 0x3C
	};

	uint8_t* actualOutput = keccak((uint8_t *) testString, size);
